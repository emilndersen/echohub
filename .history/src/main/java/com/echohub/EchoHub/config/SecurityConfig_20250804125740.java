...
public class SecurityConfig extends WebSecurityConfiguration{
    ...
    public PasswordEncoder passwordEncoder() {
        // Use a NoOpPasswordEncoder for simplicity in this example
        // In production, use a stronger password encoder like BCryptPasswordEncoder
        return PasswordEncoder.noOp();
    }
